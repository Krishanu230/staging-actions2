...
PYTHON_SCRIPT_URL="https://raw.githubusercontent.com/Krishanu230/staging-actions2/main/gen_apidocs.py"
ALIAS_NAME="knowl-gendocs"
...
echo "Installation completed. You can now use 'knowl-gendocs' to generate docs."
